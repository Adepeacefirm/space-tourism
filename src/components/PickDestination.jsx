        ...
        <div className="lg:w-[50%]">
          <nav className="flex justify-center lg:justify-start lg:ml-12 items-center gap-5 text-white">
            <NavLink
              ...
              className={`pb-2 border-b-2 border-transparent transition duration-500 ease-in-out cursor-pointer hover:border-b-2 hover:border-b-white/50 ${
                myDestination === "moon" ? "border-b-white" : ""
              }`}
            >
              MOON
            </NavLink>
            <NavLink
              className={`pb-2 border-b-2 border-transparent transition duration-500 ease-in-out cursor-pointer hover:border-b-2 hover:border-b-white/50 ${
                myDestination === "mars" ? "border-b-white" : ""
              }`}
            ...
            <NavLink
              className={`pb-2 border-b-2 border-transparent transition duration-500 ease-in-out cursor-pointer hover:border-b-2 hover:border-b-white/50 ${
                myDestination === "europa" ? "border-b-white" : ""
              }`}
            ...
            <NavLink
              className={`pb-2 border-b-2 border-transparent transition duration-500 ease-in-out cursor-pointer hover:border-b-2 hover:border-b-white/50 ${
                myDestination === "titan" ? "border-b-white" : ""
              }`}
